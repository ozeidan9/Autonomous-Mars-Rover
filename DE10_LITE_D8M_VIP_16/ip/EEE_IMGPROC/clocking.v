...
always @(*)begin
    if(distance_measure_active == 0)begin
        ...
        outbuffer = 0;
        max_width = 11'd5;
        //& r_width is in the right range
        //red works at first then when a green is put it doesnt go high and a red is put it doesnt go high...
        if (r_in_frame & (r_width > max_width) & (r_ball_registered == 0) & (r_width < 160) & (r_width > 50))begin
            max_width = r_width;
            lg_ball_watching = 0;
            g_ball_watching = 0;
            y_ball_watching = 0;
        ...
        if (g_in_frame & (g_width > max_width)  & (g_ball_registered==0) & (g_width < 160) & (g_width > 50))begin
            max_width = g_width;
            r_ball_watching = 0;
            y_ball_watching = 0;
            p_ball_watching = 0;
        ...
        if (y_in_frame & (y_width > max_width)  & (y_ball_registered==0) & & (y_width < 160) & (y_width > 50))begin
            max_width = y_width;
            r_ball_watching = 0;
            g_ball_watching = 0;
            p_ball_watching = 0;
        ...
        if (p_in_frame & (p_width > max_width)  & (p_ball_registered==0) & (p_width < 160) & (p_width > 50))begin
            max_width = p_width;
            r_ball_watching = 0;
            g_ball_watching = 0;
            y_ball_watching = 0;
        ...
        if (db_in_frame & (db_width > max_width)  & (db_ball_registered==0) & (db_width < 160) & (db_width > 50))begin
            max_width = db_width;
            r_ball_watching = 0;
            g_ball_watching = 0;
            y_ball_watching = 0;
        ...
        if (lg_in_frame & (lg_width > max_width)  & (lg_ball_registered==0) & (lg_width < 160) & (lg_width > 50))begin
            max_width = lg_width;
            r_ball_watching = 0;
            g_ball_watching = 0;
            y_ball_watching = 0;
        ...
        if(r_ball_watching == 1)begin //identifier for red: 1
            ...
            if(r_ball_registered == 1)begin //if we have already found a red ball
                ...
                no_red_ball_counter = 0;
                outbuffer = (y > 470) ? r_ball_distance : outbuffer;
            end
            ...
            db_ball_watching = 0;
            lg_ball_watching = 0;
            if(g_ball_registered == 1)begin //if we have already found a red ball
                outbuffer = 0;
                r_ball_watching = 0;
                g_ball_watching = 0;
                y_ball_watching = 0;
            ...
            else if (no_green_ball_counter > 3)begin //if there is not actually a ball in sight
                outbuffer = 0;
                r_ball_watching = 0;
                g_ball_watching = 0;
                y_ball_watching = 0;
                ...
                no_green_ball_counter = 0;
                outbuffer = (y == 476) ? g_ball_distance : outbuffer;
            end
        end
            ...
            db_ball_watching = 0;
            lg_ball_watching = 0;
            if(y_ball_registered == 3)begin //if we have already found a red ball
                outbuffer = 0;
                r_ball_watching = 0;
                g_ball_watching = 0;
                y_ball_watching = 0;
            ...
            else if (no_yellow_ball_counter > 3)begin //if there is not actually a ball in sight
                outbuffer = 0;
                r_ball_watching = 0;
                g_ball_watching = 0;
                y_ball_watching = 0;
                ...
                no_yellow_ball_counter = 0;
                outbuffer = (y == 476) ? y_ball_distance : outbuffer;
            end
        end
            ...
            db_ball_watching = 0;
            lg_ball_watching = 0;
            if(p_ball_registered == 1)begin //if we have already found a pink ball
                outbuffer = 0;
                r_ball_watching = 0;
                g_ball_watching = 0;
                y_ball_watching = 0;
            ...
            else if (no_pink_ball_counter > 3)begin //if there is not actually a ball in sight
                outbuffer = 0;
                r_ball_watching = 0;
                g_ball_watching = 0;
                y_ball_watching = 0;
                ...
                no_pink_ball_counter = 0;
                outbuffer = (y == 476) ? p_ball_distance : outbuffer;
            end
        end


        else if(db_ball_watching == 1)begin //identifier for darkblue: 5
            r_ball_watching = 0;
            g_ball_watching = 0;
            y_ball_watching = 0;
            p_ball_watching = 0;
            lg_ball_watching = 0;
            if(db_ball_registered == 1)begin //if we have already found a red ball
                outbuffer = 0;
                r_ball_watching = 0;
                g_ball_watching = 0;
                y_ball_watching = 0;
            ...
            else if (no_darkblue_ball_counter > 3)begin //if there is not actually a ball in sight
                outbuffer = 0;
                r_ball_watching = 0;
                g_ball_watching = 0;
                y_ball_watching = 0;
                ...
                no_darkblue_ball_counter = 0;
                outbuffer = (y == 476) ? db_ball_distance : outbuffer;
            end
        end
            ...
            p_ball_watching = 0;
            db_ball_watching = 0;
            if(lg_ball_registered == 1)begin //if we have already found a red ball
                outbuffer = 0;
                r_ball_watching = 0;
                g_ball_watching = 0;
                y_ball_watching = 0;
            ...
            else if (no_lightgreen_ball_counter > 3)begin //if there is not actually a ball in sight
                outbuffer = 0;
                r_ball_watching = 0;
                g_ball_watching = 0;
                y_ball_watching = 0;
                ...
                no_lightgreen_ball_counter = 0;
                outbuffer = (y == 476) ? lg_ball_distance : outbuffer;
            end
        end
    end
...
always @(posedge clk)begin
    if((x==10)&(y==10)&in_valid)begin
        ...
        if (x == IMAGE_W-10)begin
            ...
            if((white_or_black_search == 2) & white_detect & prev_w1 & prev_w2)begin
            ...
            if(!white_detect & !prev_w1 & !prev_w2)begin
                current_number_of_stripes <= current_number_of_stripes + 1;
                white_or_black_search <= 2;
                current_max_stripe <= x;
                current_stripe <= x;
...
always@(*) begin    //Write words to FIFO as state machine advances
    case(msg_state)
		...
		3'b001: begin
			msg_buf_in = {28'h10000,3'h000, distance_measure_active};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
			msg_buf_wr = 1'b1;
		end
		3'b010: begin
			msg_buf_in = {16'h2000, r_ball_distance};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
			msg_buf_wr = 1'b1;
		end
		3'b011: begin
			msg_buf_in = {28'h30000,3'h0, r_ball_registered};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
			msg_buf_wr = 1'b1;
		end
		3'b100: begin
			msg_buf_in = {11'h0,y_ball_watching,3'h0,lg_ball_watching,3'h0,p_ball_watching,3'h0,db_ball_watching,3'h0,g_ball_watching,3'h0, r_ball_watching};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
			msg_buf_wr = 1'b1;
		end
		3'b101: begin
		...
		3'b110: begin
			msg_buf_in = {21'hCCC0, r_width};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
			msg_buf_wr = 1'b1;
		end
        3'b111: begin
			msg_buf_in = {11'h0,y_in_frame,3'h0,lg_in_frame,3'h0,p_in_frame,3'h0,db_in_frame,3'h0,g_in_frame,3'h0, r_in_frame};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
			msg_buf_wr = 1'b1;
		end
    endcase
end
