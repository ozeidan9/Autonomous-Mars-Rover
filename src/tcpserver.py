...
clients = []
nicknames = []
Commandlist = []#16384+50,180,16384+50
reachedpoint=False 
investigated=False
...
while True:
    if drawin==1:
        yap.alien(loc[0],loc[1],angle,"#ffffff",dist,Longitina,Latina,Alien,map)
        drawin=0
    if drawin==2:
        print("beta detected, opinion rejected")
        yap.alien(loc[0],loc[1],angle,colours[colour],dist,Longitina,Latina,Alien,map)
        drawin=0
