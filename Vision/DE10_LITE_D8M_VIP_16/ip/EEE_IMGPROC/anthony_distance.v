...
always@(posedge clk) begin
    if (eop & in_valid & packet_video) begin  //Ignore non-video packets
        ...
        //red
        if(r_found & (r_width_check < r_height_check + 30) & (r_width_check > r_height_check - 30))begin
            r_left <= r_x_min;
            r_right <= r_x_max;
            r_top <= r_y_min;
            r_bottom <= r_y_max;
        ...
        //yellow
        if(yellow_found & (y_width_check < y_height_check + 30) & (y_width_check > y_height_check - 30))begin
            y_left <= y_x_min;
            y_right <= y_x_max;
            y_top <= y_y_min;
            y_bottom <= y_y_max;
        ...
        //darkblue
        if(darkblue_found & (db_width_check < db_height_check + 30) & (db_width_check > db_height_check - 30))begin
            db_left <= db_x_min;
            db_right <= db_x_max;
            db_top <= db_y_min;
            db_bottom <= db_y_max;
        ...
        //pink
        if(pink_found & (p_width_check < p_height_check + 30) & (p_width_check > p_height_check - 30))begin
            p_left <= p_x_min;
            p_right <= p_x_max;
            p_top <= p_y_min;
            p_bottom <= p_y_max;
