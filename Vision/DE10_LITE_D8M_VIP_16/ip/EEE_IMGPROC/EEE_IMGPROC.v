...
////added
//reg r_too_close, r_too_close_prev1, r_too_close_prev2, r_too_close_total;
//reg g_too_close, g_too_close_prev1, g_too_close_prev2, g_too_close_total;
//reg y_too_close, y_too_close_prev1, y_too_close_prev2, y_too_close_total;
//reg p_too_close, p_too_close_prev1, p_too_close_prev2, p_too_close_total;
//reg db_too_close, db_too_close_prev1, db_too_close_prev2, db_too_close_total;
//reg lg_too_close, lg_too_close_prev1, lg_too_close_prev2, lg_too_close_total;
//reg[10:0] lg_pixel_count, lg_frame_pixel_count;
//
////end
...
//reg[2:0] no_yellow_ball_counter;
...
//	p_too_close_total = 0;
//	db_too_close = 0; 
//	db_too_close_prev1 = 0; 
//	db_too_close_prev2 = 0;
//	db_too_close_total = 0;
//	lg_too_close = 0; 
//	lg_too_close_prev1 = 0;
//	lg_too_close_prev2 = 0;
//	lg_too_close_total = 0;
//	lg_pixel_count = 0;
//	//end
...
//        r_prev_frame1 <= red_found & (r_width1 < r_width + 10) & (r_width1 > r_width - 10) & (r_width > 40) & (r_height > 20);
//    
...
//        g_prev_frame1 <=  green_found & (g_width1 < g_width + 10) & (g_width1 > g_width - 10)  & (g_width > 40) & (g_height > 25);
//    
...
//        y_prev_frame1 <=  yellow_found & (y_width1 < y_width + 10) & (y_width1 > y_width - 10)  & (y_width > 40) & (y_height > 25);
//
...
//        p_prev_frame1 <=  pink_found & (p_width1 < p_width + 10) & (p_width1 > p_width - 10)  & (p_width > 40) & (p_height > 25);
//
...
//        db_prev_frame1 <=  darkblue_found & (db_width1 < db_width + 10) & (db_width1 > db_width - 10)  & (db_width > 40) & (db_height > 25);
//
...
//        lg_prev_frame1 <=  lightgreen_found & (lg_width1 < lg_width + 10) & (lg_width1 > lg_width - 10)  & (lg_width > 40) & (lg_height > 25);
//
//        building_prev_frame3 <=  building_prev_frame2 & (building_width3 > 30) & (building_width2 < building_width3 + 15) & (building_width2 > building_width3 - 15);
//        building_prev_frame2 <=  building_prev_frame1 & (building_width2 > 30) & (building_width1 < building_width2 + 15) & (building_width1 > building_width2 - 15);
//        building_prev_frame1 <=  building_found & (building_width > 30) & (building_width < building_width1 + 15) & (building_width > building_width1 - 15);
//
//
//        // if (r_in_frame)begin
//        //     if (r_x_max - r_x_min < r_width + 10 & r_x_max-r_x_min >  - 10)begin
...
//        lg_width1 <= lg_width;
//
//        building_width <= frame_biggest_stripe_right - frame_biggest_stripe_left;
...
//
//    if (y== 479 & x==10)begin
//        if(frame_biggest_stripe_right - frame_biggest_stripe_left > 90 & prev_frame_number_of_stripes > 2) begin //colliding into a ball...
//            outbuffer <= 13;
//        end
//        else begin
//
...
//            else if (0 & (g_ball_registered == 0) & (g_width < 160) & (g_width > 40) & (g_width > r_width | r_x_max == 0 | r_width > 160) & (g_width > y_width | y_x_max == 0 | y_width > 160) & (g_width > p_width | p_x_max == 0 | p_width > 160) & (g_width > lg_width | lg_x_max == 0 | lg_width > 160) & (g_width > db_width | db_x_max == 0 | db_width > 160))begin
//                lg_ball_watching <= 0;
//					 outbuffer <= 0;
//                y_ball_watching <= 0;
//                p_ball_watching <= 0;
...
//            else if (0 & (db_ball_registered == 0) & (db_width < 160) & (db_width > 40) & (db_width > g_width | g_x_max == 0 | g_width > 160) & (db_width > y_width | y_x_max == 0 | y_width > 160) & (db_width > p_width | p_x_max == 0 | p_width > 160) & (db_width > lg_width | lg_x_max == 0 | lg_width > 160) & (db_width > r_width | r_x_max == 0 | r_width > 160))begin
//                lg_ball_watching <= 0;
//                g_ball_watching <= 0;
//                y_ball_watching <= 0;
//                p_ball_watching <= 0;
...
//                distance_measure_active <= 1;
//            end
//				else if(building_in_frame)begin
//                outbuffer <= 14;
//					 g_ball_watching <= 0;
//                y_ball_watching <= 0;
//                p_ball_watching <= 0;
...
//reg[5:0] current_number_of_stripes;
//reg[5:0] prev_frame_number_of_stripes, frame_1_stripes, frame_2_stripes, frame_3_stripes, max_number_of_stripes;
//reg[3:0] non_white_counter;
//reg[10:0] current_min_stripe;
//reg[10:0] current_max_stripe;
//reg[10:0] frame_min_stripe;
//reg[10:0] frame_max_stripe;
//reg[10:0] current_stripe;
//reg[10:0] current_stripe_width;
//reg[10:0] max_min_stripe; 
//reg[10:0] max_max_stripe;
//
//reg[10:0] frame_biggest_stripe_right, frame_biggest_stripe_left;
//reg[10:0] current_biggest_stripe_right, current_biggest_stripe_left;
//reg[10:0] max_biggest_stripe_right, max_biggest_stripe_left;
//
...
//    frame_biggest_stripe_right = 0;
//    frame_biggest_stripe_left = 0;
...
//
//always @(posedge clk)begin
//    if((x==1)&(y==1)&in_valid)begin
//        prev_frame_number_of_stripes <= max_number_of_stripes;
//        if(max_number_of_stripes > 3)begin
//            building_found <= 1;
//        end
//        else begin
//            building_found <= 0;
...
//    end
//    
//    else if( (x>=10) & (x<=IMAGE_W-10) & in_valid & (y > 220) & (y % 5 == 0) & (y < 475))begin
//        if (x == IMAGE_W-10)begin
//            if (current_number_of_stripes > max_number_of_stripes)begin
//                max_number_of_stripes <= current_number_of_stripes;
//                max_min_stripe <= current_min_stripe;
...
//            white_or_black_search <= 1;
//            non_white_counter <= 0;
//            if(current_number_of_stripes == 0)begin
//                current_min_stripe <= x;
//            end
//            current_max_stripe <= x;
//            if(current_number_of_stripes > 0)begin
//                if ((x - current_stripe < current_stripe_width) & stripe_size_increasing == 1)begin
//                    stripe_size_increasing <= 0;
//                end
//                current_stripe_width <= x - current_stripe;
//                if (current_number_of_stripes == 2)begin
//                    current_number_of_buildings <= 1;
//                end
//                else if ((x-current_stripe > current_stripe_width) & stripe_size_increasing == 0 & current_number_of_stripes > 2)begin
//                    current_number_of_buildings <= current_number_of_buildings + 1;
//                    stripe_size_increasing <= 1;
//                end
//            end
...
//
//            if(current_number_of_stripes == 0)begin
//                current_biggest_stripe_left <= x;
//                current_biggest_stripe_right <= x;
//            end
//            
//            else if(x - current_stripe > current_biggest_stripe_right - current_biggest_stripe_left) begin
//                current_biggest_stripe_left <= current_stripe;
//                current_biggest_stripe_right <= x;
//            end
//
//            current_stripe <= x;
...
//                current_stripe <= x;
//                if(current_number_of_stripes > 0)begin
//                    if(current_number_of_stripes > 1)begin
//                        if ((x - current_stripe < current_stripe_width) & stripe_size_increasing == 1)begin
//                            stripe_size_increasing <= 0;
//                        end
//                        current_stripe_width <= x - current_stripe;
...
////     prev_frame_number_of_stripes <= (frame_3_stripes > frame_2_stripes) ? ((frame_3_stripes > frame_1_stripes) ? frame_3_stripes : frame_1_stripes) : 
...
//                lightgreen_found <= 1;
//					 lg_pixel_count <= lg_pixel_count + 1;
//            end
//        end
...
//        //red
//		  lg_frame_pixel_count <= lg_pixel_count;
//        if(red_found & (r_x_max - r_x_min < r_y_max - r_y_min + 30) & (r_x_max - r_x_min > r_y_max - r_y_min - 30) )begin
//            r_left	<= r_x_min;
//            r_right <= r_x_max;
//            r_top <= r_y_min;
//            r_bottom <= r_y_max;
...
//        //BUILDINGS
//    
//        build_left <= frame_min_stripe;
//        build_right <= frame_max_stripe;
//        
...
//		end
//		3'b001: begin
//			msg_buf_in = {16'hAAAA,16'h0};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
//			msg_buf_wr = 1'b1;
//		end
//		3'b010: begin
//            msg_buf_in = {16'hBBBB, 10'h0, prev_frame_number_of_stripes};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
//			msg_buf_wr = 1'b1;
//		end
//		3'b011: begin
...
//		end
//		3'b100: begin
//			msg_buf_in = {16'hDDDD,5'h0, r_width};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
//			msg_buf_wr = 1'b1;
//		end
//		3'b101: begin
//            msg_buf_in = {16'hABCD,4'h0,3'h0, r_in_frame, 3'h0,r_prev_frame1, 3'h0,r_prev_frame2};	//Green Colour ID, 0-bit+ g_x_max, 0-bit + g_x_min
//			msg_buf_wr = 1'b1;
//		end
//		3'b110: begin
//			msg_buf_in = {11'h1,y_ball_watching,3'h0,lg_ball_watching,3'h0,p_ball_watching,3'h0,db_ball_watching,3'h0,g_ball_watching,3'h0, r_ball_watching};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
//			msg_buf_wr = 1'b1;
//		end
//        3'b111: begin
...
//    .lg_x_max(lg_x_max),
//    .lg_x_min(lg_x_min),
//    .building_detect(building_detect),
//    .frame_biggest_stripe_right(frame_biggest_stripe_right),
//    .frame_biggest_stripe_left(frame_biggest_stripe_left),
//    .build_left(build_left),
//    .build_right(build_right),
//    .number_of_stripes(prev_frame_number_of_stripes),
...
//    .build_ball_distance(build_ball_distance),
//);
//
//
//
...
always @(posedge clk) begin
    ...
    if (y == 479 & x == 10)begin
			...
			lg_too_close <= (lg_top >=  375) & (lg_frame_pixel_count > 1300);
			lg_too_close_prev1 <= lg_too_close;
			lg_too_close_prev2 <= lg_too_close_prev1;
			lg_too_close_total <= lg_too_close & lg_too_close_prev1;
...
always @(posedge clk)begin
    ...
    if (y== 479 & x==10)begin
        if(frame_biggest_stripe_right - frame_biggest_stripe_left > 90 & prev_frame_number_of_stripes > 3) begin //colliding into a ball...
            outbuffer <= 13;
        end
        else begin
...
always@(*) begin    //Write words to FIFO as state machine advances
    case(msg_state)
		...
		3'b001: begin
			msg_buf_in = {16'hABCD, outbuffer};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
			msg_buf_wr = 1'b1;
		end
		3'b010: begin
            msg_buf_in = {16'hAAAA, 5'h0, lg_top};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
			msg_buf_wr = 1'b1;
		end
		3'b011: begin
			msg_buf_in = {16'hCCCC,outbuffer};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
		...
		3'b100: begin
			msg_buf_in = {16'hBCBC, 13'h0,lg_too_close_prev1, lg_too_close_prev2,lg_too_close};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
			msg_buf_wr = 1'b1;
		end
		3'b101: begin
            msg_buf_in = {11'h1,y_ball_registered,3'h0,lg_ball_registered,3'h0,p_ball_registered,3'h0,db_ball_registered,3'h0,g_ball_registered,3'h0, r_ball_registered};	//Green Colour ID, 0-bit+ g_x_max, 0-bit + g_x_min
			msg_buf_wr = 1'b1;
		end
		3'b110: begin
			msg_buf_in = {11'h1,y_ball_watching,3'h0,lg_ball_watching,3'h0,p_ball_watching,3'h0,db_ball_watching,3'h0,g_ball_watching,3'h0, r_ball_watching};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
