...
//GREEN
always @(posedge clk)begin
    if((g_x_max > 320) & (g_x_min < 320) & (g_ball_center < 350) & (g_ball_center > 300))begin
...
//YELLOW
always @(posedge clk)begin
    if((y_x_max > 320) & (y_x_min < 320) & ( y_ball_center < 350) & (y_ball_center > 300))begin
...
//PINK
always @(posedge clk)begin
    if((p_x_max > 320) & (p_x_min < 320) & ( p_ball_center < 350) & (p_ball_center > 300))begin
...
//DARK BLUE
always @(posedge clk)begin
    if((db_x_max > 320) & (db_x_min < 320) & ( db_ball_center < 350) & (db_ball_center > 300))begin
...
//LIGHT GREEN
always @(posedge clk)begin
    if((lg_x_max > 320) & (lg_x_min < 320) & ( lg_ball_center < 350) & (lg_ball_center > 300))begin
