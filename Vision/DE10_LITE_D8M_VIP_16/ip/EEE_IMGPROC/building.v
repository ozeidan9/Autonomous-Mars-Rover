...
always@(*) begin    //Write words to FIFO as state machine advances
    case(msg_state)
		...
		3'b011: begin
			msg_buf_in = {16'hCCCC,5'h0,frame_biggest_stripe_right-frame_biggest_stripe_left};	//Green Colour ID, 0-bit + g_x_max, 0-bit + g_x_min
			msg_buf_wr = 1'b1;
		end
		3'b100: begin
...
endmodulef   (s_address == `READ_ID) s_readdata <= 32'h1234EEE2;
        if   (s_address == `REG_BBCOL) s_readdata <= {8'h0, bb_col};
    end
    read_d <= s_read;
end
