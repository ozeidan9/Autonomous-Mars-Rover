...
entity alt_cusp180_general_fifo is
	generic
	(
		WIDTH	           : integer := 8;
		DEPTH	           : integer := 4;
...
architecture rtl of alt_cusp180_general_fifo is
...
begin
	...
	begin
		...
		logic_fifo : alt_cusp180_logic_fifo
		generic map
		(
			WIDTH              => WIDTH,
			DEPTH              => DEPTH
	...
	begin
		...
		begin	
			...
			output_logic_fifo : alt_cusp180_logic_fifo
			generic map
			(
				WIDTH              => WIDTH,
			...
			logic_fifo_rdreq_delayer : alt_cusp180_one_bit_delay
			generic map
			(
			...
			ram_fifo_rdreq_delayer : alt_cusp180_one_bit_delay
			generic map
			(
