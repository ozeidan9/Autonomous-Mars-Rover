...
int batperc(float batdrain) { //the actual function, like "batpercent = batperc(batdrain);  SEND batpercent;". Stick this before loop, I just stuck it here so you can see integration
    int batcap = 90000;
    float batpercent = ((batcap - batdrain)/batcap)*100; //calculate the percentage
    int batpercout = batpercent;
    return batpercout;
}
...
//  if(millis() % 5 == 0){
//     sendtoServer(0, total_x, total_y); //position sending with opcode 0;
//  }
